...
Der **1.0.3-Kandidat** verbindet den nativen Pulsar-Ursprung mit drei eigenen Bitterküsten-Materialien und dem optionalen [Herzbrief-Pfad](docs/HEART-LETTER.md) direkt in Morrowind. [Reborn-Kartografie](docs/REBORN-CARTOGRAPHY.md) beschreibt die lokale Landzellen-Zuordnung und die noch offene Bildprüfung. Der Herzbrief startet über **F8 → Herzbrief**, verlangt einen gelesenen Text und ein Gespräch mit einer echten Spielfigur und schaltet gezielt den normalen LOVE-Heilzauber frei. Der lokale 1.0.2-Vorschaustand enthält den Herzbrief noch nicht; für ihn ist ein Neustart nach dem nächsten Patch nötig.
